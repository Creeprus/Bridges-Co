            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.CheckConstraint(name:"Check_numbers_Series_Passport",sql: "Series_Passport like '[0-9][0-9][0-9][0-9]'"

                        );
                    table.CheckConstraint(name: "Check_numbers_Number_Passport", sql: "Number_Passport like '[0-9][0-9][0-9][0-9][0-9][0-9]'"
